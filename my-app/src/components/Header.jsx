...
import Header.module from "./styles/Header.module.css";
        ...
        <header className="bg-blue-600 text-white py-4 px-6 flex justify-between items-center">
            ...
            <nav>
                <ul className="flex space-x-6">
                    ...
                    <li><a href="/logar" className="bg-white text-blue-600 px-4 py-2 rounded hover:bg-gray-200">Logar</a></li>
                    <li><a href="/criar-conta" className="bg-blue-800 px-4 py-2 rounded hover:bg-blue-700">Criar Conta</a></li>
                </ul>
            </nav>
        </header>
    );
